...
import { ActionSignInUser } from "../actions" // Verifique o caminho da sua action
...
export function FormSignIn({
    ...
    // 1. Definição do formulário com useForm e zodResolver
                        ...
                        <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
                            ...
                            <div className="space-y-4">
                                ...
                                <FormDescription className="text-center">
                                    ...
                                    <a href="#" className="underline-offset-4 hover:underline" aria-disabled={isPending}>
                                        Registre-se
                                    </a>
                                </FormDescription>
                            </div>
